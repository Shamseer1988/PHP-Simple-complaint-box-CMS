                                    ...
                                    <div class="bg-info b-r-4 card-body">
                                        <div class="media static-top-widget">
                                            ...
                                            <div class="media-body">
                                                <?php
                                                $rt = mysqli_query($db, "SELECT * FROM tblcomplaints where userId='" . $_SESSION['UserId'] . "' and status is null");
                                    ...
                                    <div class="bg-primary b-r-4 card-body">
                                        <div class="media static-top-widget">
                                            ...
                                            <div class="media-body">
                                                <?php
                                                $status = "in Process";
                                                $rt = mysqli_query($db, "SELECT * FROM tblcomplaints where userId='" . $_SESSION['UserId'] . "' and  status='$status'");
                                                $num1 = mysqli_num_rows($rt); { ?>
